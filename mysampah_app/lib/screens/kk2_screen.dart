...
class KK2Screen extends StatelessWidget
{
  const KK2Screen({super.key});
  @override
      ...
      (
        ...
        [
          ...
          (
            ...
            color: Colors.white,
            tooltip: 'Next',
            onPressed: (){Navigator.pushNamed(context, '/kk12');},
          ),
        ],
...
class KK2Widget extends StatelessWidget
{
      ...
      [
          ...
          (
            ...
            [
              ...
              (
                ...
                child: Image.asset('assets/images/KK2.png', width: 600,height: 300,),
              ),
            ],
          ),
        ),
        ...
        (
          ...
          child: TextButton.icon
              (
                ...
                label: Text('Kolej Kediaman Tunku Bahiyah, Universiti Malaya', style: TextStyle(fontSize: 9),),
        ...
        ( 
          ...
          (
            ...
            child: TextButton.icon
            (
              onPressed: ()=> logBin("Go to Hub","rocket_launch", "Bin KK2"),
              style: TextButton.styleFrom
              (
          ...
          (
            ...
            child: TextButton.icon
            (
              onPressed: ()=> logBin("Return Point","undo", "Bin KK2"),
              style: TextButton.styleFrom
              (
          ...
          (
            ...
            child: TextButton.icon
            (
              onPressed: ()=> logBin("Alert Alarm","warning", "Bin KK2"),
              style: TextButton.styleFrom
              (
                backgroundColor: const Color.fromARGB(255, 209, 103, 96),
                foregroundColor: Colors.black,
