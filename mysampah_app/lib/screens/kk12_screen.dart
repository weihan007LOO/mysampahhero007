...
class KK12Screen extends StatelessWidget
{
  const KK12Screen({super.key});
  @override
      ...
      (
        ...
        [
          ...
          (
            ...
            color: Colors.white,
            tooltip: 'Settings',
            onPressed: (){Navigator.pushNamed(context, '/kk1');},
          ),
        ],
...
class KK12Widget extends StatelessWidget
{
          ...
          (
            ...
            [
              ...
              (
                ...
                child: Image.asset('assets/images/KK12.png', width: 600,height: 300,),
              ),
            ],
          ),
        ),
        ...
        (
          ...
          child: TextButton.icon
              (
                ...
                label: Text('Kolej Kediaman Dr. Nazrin Shah (KK12), Universiti Malaya', style: TextStyle(fontSize: 9),),
        ...
        ( 
          ...
          top:415,
            ...
            (
              ...
              progressColor: const Color.fromARGB(255, 63, 179, 208),
          ...
          (
            ...
            child: TextButton.icon
            (
              onPressed: ()=> logBin("Go to Hub","rocket_launch", "Bin KK12"),
              style: TextButton.styleFrom
              (
          ...
          (
            ...
            child: TextButton.icon
            (
              onPressed: ()=> logBin("Return Point","undo", "Bin KK12"),
              style: TextButton.styleFrom
              (
          ...
          (
            ...
            child: TextButton.icon
            (
              onPressed: ()=> logBin("Alert Alarm","warning", "Bin KK12"),
              style: TextButton.styleFrom
              (
                backgroundColor: const Color.fromARGB(255, 209, 103, 96),
                foregroundColor: Colors.black,
